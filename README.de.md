...
**Türkei · Vereinigte Staaten · Indien · Vereinigtes Königreich · Deutschland · Brasilien · Frankreich.**
...
<p align="center">
  <img src="docs/images/home.png" alt="Masthead-Titelseite: die Topmeldung, ein Laufband mit Eilmeldungen und eine laufende Zeitleiste der neuesten Schlagzeilen" width="100%" />
</p>

## Warum Masthead?

Nachrichten zu verfolgen heißt meist: ein Dutzend Browser-Tabs, Cookie-Banner, automatisch startende Videos und
Pop-ups. Masthead führt **955 Redaktionen aus sieben Ländern** — die Presse jedes Landes, in seiner eigenen Sprache —
...
- **Regionales überall.** Wählen Sie Ihre Stadt in der Türkei, Ihren Bundesstaat in den USA, Brasilien oder Indien,
  Ihr Bundesland, Ihr Gebiet im Vereinigten Königreich oder Ihr Département in Frankreich: Die Medien vor Ort
  kommen dazu, samt jeder überregionalen Meldung, die den Ort nennt.
...
| | |
| --- | --- |
| ![Überblick: eine Meldung, die Schlagzeile jedes Mediums](docs/images/digest.png) | ![Die Seite eines Mediums, geöffnet in der App](docs/images/in-app.png) |
...
| ![Lesemodus](docs/images/reader.png) | ![Neueste, türkische Oberfläche, dunkles Design](docs/images/latest-tr.png) |
...
Vereinigten Königreich, ein Département in Frankreich. Die Sprache der Oberfläche ist davon unabhängig: Lesen Sie brasilianische Zeitungen mit
...
| 🇺🇸 **Vereinigte Staaten** — 104 überregionale Redaktionen, von NPR und der NYT bis Fox News und dem WSJ, dazu Lokales für jeden Bundesstaat | 🇬🇧 **Vereinigtes Königreich** — BBC, Guardian, Telegraph, Sky News, die FT… und BBC-Lokalnachrichten für 51 Gebiete |
...
| 🇮🇳 **Indien** — die Hindi-Presse (अमर उजाला, दैनिक भास्कर, नवभारत टाइम्स, हिन्दुस्तान, आज तक…) und die Seite „Regional“ für Ihren Bundesstaat | 📖 **Lesemodus** — der Artikel und sonst nichts, in Ihrer eigenen Leseschrift |

🇫🇷 **Frankreich** — franceinfo, Le Monde, Le Figaro, Le Parisien, Libération, Les Echos, L'Équipe… mit der Oberfläche
auf Französisch, dazu Lokales für alle 101 Départements: France 3, der ici-Sender der Region und die Regionalzeitungen.
...
> - macOS öffnet die App beim ersten Mal nicht: Wählen Sie in den Systemeinstellungen → Datenschutz & Sicherheit
>   **Dennoch öffnen**. (0.4.0 und älter heißen womöglich „beschädigt“: einmal `xattr -cr /Applications/Masthead.app` ausführen.)
...
| 📍 **Regionale Nachrichten** | 81 türkische Provinzen, 50 US-Bundesstaaten und D.C., 36 indische Bundesstaaten, 16 Bundesländer, 27 brasilianische Bundesstaaten, 51 britische Gebiete, 101 französische Départements — Medien vor Ort und Meldungen, die den Ort nennen |
...
| 🌍 **Länder** | Türkei, Vereinigte Staaten, Indien, Vereinigtes Königreich, Deutschland, Brasilien und Frankreich — in den Einstellungen wechseln |
| 🔄 **Automatische Updates** | Neue Versionen laden im Hintergrund; ein Klick startet sie |
| 💬 **Sprachen** | Oberfläche: English, Türkçe, Deutsch, Português, हिन्दी und Français — die Nachrichten bleiben in ihrer eigenen Sprache |
...
Sprache des Landes: Indien liest seine Hindi-Presse, Deutschland seine deutschen, Frankreich seine französischen Redaktionen.

| Land | Quellen | Feeds |
| --- | --- | --- |
| 🇹🇷 Türkei | 136 (67 national + regional: Stadt-Feeds für alle 81 Provinzen, Zeitungen in 33 davon) | 536 |
| 🇺🇸 Vereinigte Staaten | 227 (104 überregional + 123 Lokalredaktionen, zwei bis drei in jedem Bundesstaat und D.C.) | 299 |
| 🇮🇳 Indien | 48, alle auf Hindi (40 überregional + die Bundesstaats-Seiten von acht Zeitungen, 23 Bundesstaaten) | 263 |
| 🇬🇧 Vereinigtes Königreich | 139 (71 überregional + BBC-Lokalnachrichten für 51 Gebiete und 67 Regionalzeitungen) | 251 |
| 🇩🇪 Deutschland | 154 (99 überregional + Regionales für alle 16 Bundesländer aus 55 Redaktionen) | 249 |
| 🇧🇷 Brasilien | 130 (95 überregional + g1 für alle 27 Bundesstaaten und 34 Regionalzeitungen) | 221 |
| 🇫🇷 Frankreich | 121 (78 überregional + France 3, ici und Regionalzeitungen für alle 101 Départements) | 423 |
